...
public:
    ...
    std::string _name, std::string _summery, std::string _director, std::string exist_or_delete);
    int get_id();
    void set_year(std::string _year);
    void set_length(std::string _length);
    void set_name(std::string _name);
    void set_summery(std::string _summery);
    void set_director(std::string _director);
    void delete_film();
    int get_price();
    std::string get_name();
    std::string get_exist_or_delete();
    void set_customers_rote_to_film(int rote, int customer_id);
    void set_rote();
...
private:
    ...
    float rate;
    std::vector<std::vector<int> > customers_rote_to_film;
